# Simple Wireframe With React

## Instructions to install from the GIT REPO
...
### 6. Go to your browser and type http://localhost:3000 and you should see the wireframe.
